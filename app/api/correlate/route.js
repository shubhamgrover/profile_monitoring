...
- If the input payload has no active job openings, news, or social posts, do NOT return an empty list of correlations. Instead, generate at least 2 strategic correlations explaining how a company of their scale and industry can reduce paid acquisition costs, replace traditional ad networks, or optimize GTM budget using our solution ("${productDesc}").
...
- DO NOT invent, assume, or hallucinate signals (such as "search activity for CRM" or "sales enablement tooling") that are not explicitly provided in the raw input data. If raw inputs exist, ground your correlations strictly in them.
