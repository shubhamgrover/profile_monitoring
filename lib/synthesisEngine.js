  ...
  if (companyName.toLowerCase().includes('factors.ai') || companyName.toLowerCase().includes('factors')) {
    ...
    if (youtube.length > 0 || tweets.length > 0 || posts.length > 0) {
      strategicCorrelations.push({
        ...
        friction: "Capitalizing on organic content attention spikes and converting brand engagement into trusted audience access.",
        script: `Which means this can be our pitch: "Loved the recent brand content drive. Since active social posts and mentions exist, it generally means you are capturing solid market interest. We help teams use ${productName} to reach, influence, and engage these high-intent audiences with credibility and measurable marketing impact. Worth a quick chat?"`
      });
    }
    ...
    if (reddit.length > 0 || news.length > 0) {
      strategicCorrelations.push({
        ...
        friction: "Building thought leadership, executive trust, and category authority across premium media channels.",
        script: `Which means this can be our pitch: "I saw the recent media coverage and community discussions. Since PR news and public comments exist, it generally means interest in your space is spiking. We help brands build thought leadership and category authority across Hindustan Times and Mint. Worth a touchpoint?"`
      });
    }
    ...
    strategicCorrelations.push({
      ...
      friction: "Managing context sharing, reducing new hire recruitment timelines, and scaling employer branding.",
      script: `Which means this can be our pitch: "I saw the team scaling. Since new hiring and active growth exist, it generally means scaling talent acquisition is a priority. We help teams run hyper-targeted recruitment and employer branding campaigns across HT digital and print properties. Worth a quick chat?"`
    });
    ...
    strategicCorrelations.push({
      ...
      friction: "Eliminating data silos and targeting audiences based on clean first-party data syncs.",
      script: `Which means this can be our pitch: "I was looking at the recent web sitemap updates. Since sitemap additions and active tracking exist, it generally means your marketing ops team is refining integrations. We use ${productName} to sync first-party data segments with HT One Audience targeting to optimize ad spend. Worth a brief look?"`
    });
    ...
    strategicCorrelations.push({
      ...
      friction: "Moving from buying simple media space to buying trusted audience access and business-relevant engagement.",
      script: `Which means this can be our pitch: "I saw the buying intent signals. Since active expansion and intent triggers exist, it generally means you are consolidating growth tools. We help teams use ${productName} to move from buying media space to buying trusted audience access, category influence, and business-relevant engagement. Worth a touchpoint?"`
    });
