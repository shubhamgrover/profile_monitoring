  ...
  if (companyName.toLowerCase().includes('factors.ai') || companyName.toLowerCase().includes('factors')) {
    ...
    if (sitemaps.length > 0 && jobs.length > 0) {
      strategicCorrelations.push({
        ...
        friction: isHR
          ? "Bridging capabilities gaps within the recruiting, sourcing, and L&D teams themselves to handle rapid scale."
          : "Syncing product marketing updates and targeting highly relevant digital audience cohorts.",
        script: isHR
          ? `Which means this can be our pitch: "I noticed ${companyName} is expanding its digital sitemaps alongside hiring for ${jobs.length} new roles. With this rapid growth, ensuring your recruiting and talent acquisition teams are equipped with modern sourcing capabilities is key. We help HR leaders leverage ${productName} to provide specialized upskilling and training courses specifically for recruiters, L&D managers, and talent partners. Worth a brief chat?"`
    ...
    if (youtube.length > 0 || tweets.length > 0 || posts.length > 0) {
      strategicCorrelations.push({
        ...
        script: isHR
          ? `Which means this can be our pitch: "Loved the recent brand content drive from ${companyName}. As your public market presence accelerates, having an upskilled people operations team is critical to guide employee engagement. We help HR leaders use ${productName} to deliver training and capability development courses specifically for your internal HR, L&D, and employee experience teams. Worth a quick chat?"`
    ...
    if (reddit.length > 0 || news.length > 0) {
      strategicCorrelations.push({
        ...
        script: isHR
          ? `Which means this can be our pitch: "I saw the recent media coverage and public discussions surrounding ${companyName}'s strategic transition. During periods of change, having an upskilled HR team is critical to manage employee trust and alignment. We help companies leverage ${productName} to provide specialized change-management and leadership upskilling courses for L&D and talent teams. Worth a touchpoint?"`
    ...
    strategicCorrelations.push({
      ...
      script: isHR
        ? `Which means this can be our pitch: "I noticed your active team scaling and operational growth. As you onboard new talent, ensuring your recruiting team and hiring managers are aligned is essential. We help organizations leverage ${productName} to run training and upskilling programs for hiring managers and recruiters, helping your talent acquisition team source and assess more effectively. Worth a quick chat?"`
    ...
    strategicCorrelations.push({
      ...
      script: isHR
        ? `Which means this can be our pitch: "I was looking at the recent system updates at ${companyName}. As you implement new tools and processes, ensuring your HR operations staff is technically upskilled is vital. We use ${productName} to deliver tailored functional training courses specifically for your HR ops and people operations teams to ensure they can manage new systems. Worth a brief look?"`
